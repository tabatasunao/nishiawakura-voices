      ...
      <CardContent className="pt-4 pb-2">
        <div className="flex items-start gap-3">
          <span className={`text-2xl font-bold tabular-nums w-8 text-center flex-shrink-0 ${
            isTop10 ? 'text-forest' : 'text-gray-500'
          }`}>
            {rank}
          </span>
          <div className="flex-1 min-w-0">
            ...
            <Link href={`/questions/${question.id}`} className="font-semibold text-gray-900 hover:text-forest leading-snug line-clamp-2 py-1 block">
